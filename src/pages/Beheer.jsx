...
const ROL_STANDAARD = {
  beheerder: ['/trainingen','/leden','/wedstrijden','/examens','/technieken','/uitbetalingen','/winkel','/verkoop','/stock','/rapporten','/communicatie','/documenten','/eetfestijn','/beheer'],
...
export default function Beheer() {
  ...
  return (
    <div style={S.page}>
      ...
      {/* Pagina's per rol */}
      <div style={S.card}>
        <div style={S.cardTitle}>🔐 Pagina's per rol</div>
        <PaginaRollenBeheer />
      </div>
