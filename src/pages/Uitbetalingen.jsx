                    ...
                    <tr style={{borderTop:`1px solid ${C.border}`}}>
                      <td colSpan={data.datums.length+5} style={{padding:0}}>
                        <div style={{background:'rgba(255,255,255,0.03)',padding:'12px 16px 16px 40px'}}>
                          ...
                          {/* Alle trainingen in periode, met toggle voor deze lesgever */}
                          {(data.trainingen||[]).length===0
                            ...
                            : (data.trainingen||[]).map(t=>{
                                ...
                                // Normaliseer naar id's voor vergelijking
                                ...
                                return (
                                  <div key={t.id} style={{display:'flex',alignItems:'center',gap:'10px',padding:'8px 12px',background:isAanwezig?'rgba(34,197,94,0.08)':C.card,border:`1px solid ${isAanwezig?'rgba(34,197,94,0.25)':C.border}`,borderRadius:'8px',marginBottom:'6px'}}>
                                    {/* Toggle aanwezigheid */}
                          ...
                          {/* Samenvatting aanwezige trainingen */}
                          <div style={{marginTop:'10px',fontSize:'12px',color:C.textMuted,fontStyle:'italic'}}>
                            {mijnTrainingen.length} training{mijnTrainingen.length!==1?'en':''} aanwezig in periode
                          </div>
                        </div>
                      </td>
                    </tr>
