...
// Centrale HTML-mailtemplate. Gedeeld via re-export in verstuurMail.js.
// Server-side equivalent: functions/mailHtmlBuilder.js (CommonJS).
 ...
 */
export function bouwMailHtml(titel, inhoud, clubnaam = 'Kodokan Merchtem', cta = null) {
