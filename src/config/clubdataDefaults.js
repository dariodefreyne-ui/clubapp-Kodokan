...
export const DEFAULT_LEEFTIJDSCATEGORIEEN = [
  { code: 'U7',        label: 'U7',         vanLeeftijd: 0,  totLeeftijd: 6,  volgorde: 10,  kleur: '#d97706' },
  { code: 'U9',        label: 'U9',         vanLeeftijd: 7,  totLeeftijd: 8,  volgorde: 20,  kleur: '#fb923c' },
  { code: 'U11',       label: 'U11',        vanLeeftijd: 9,  totLeeftijd: 10, volgorde: 30,  kleur: '#22c55e' },
  { code: 'U13',       label: 'U13',        vanLeeftijd: 11, totLeeftijd: 12, volgorde: 40,  kleur: '#38bdf8' },
  { code: 'U14',       label: 'U14',        vanLeeftijd: 13, totLeeftijd: 13, volgorde: 50,  kleur: '#a78bfa' },
  { code: 'U15',       label: 'U15',        vanLeeftijd: 14, totLeeftijd: 14, volgorde: 60,  kleur: '#fb923c' },
  { code: 'U16',       label: 'U16',        vanLeeftijd: 15, totLeeftijd: 15, volgorde: 70,  kleur: '#e63346' },
  { code: 'U18',       label: 'U18',        vanLeeftijd: 16, totLeeftijd: 17, volgorde: 80,  kleur: '#38bdf8' },
  { code: 'U21',       label: 'U21',        vanLeeftijd: 18, totLeeftijd: 20, volgorde: 90,  kleur: '#a78bfa' },
  { code: 'Veteranen', label: 'Veteranen',  vanLeeftijd: 30, totLeeftijd: 99, volgorde: 100, kleur: '#0d9488' },
  { code: 'V1',        label: 'V1 (30–34)', vanLeeftijd: 30, totLeeftijd: 34, volgorde: 101, kleur: '#0d9488' },
  { code: 'V2',        label: 'V2 (35–39)', vanLeeftijd: 35, totLeeftijd: 39, volgorde: 102, kleur: '#0d9488' },
  { code: 'V3',        label: 'V3 (40–44)', vanLeeftijd: 40, totLeeftijd: 44, volgorde: 103, kleur: '#0d9488' },
  { code: 'V4',        label: 'V4 (45–49)', vanLeeftijd: 45, totLeeftijd: 49, volgorde: 104, kleur: '#0d9488' },
  { code: 'V5',        label: 'V5 (50–54)', vanLeeftijd: 50, totLeeftijd: 54, volgorde: 105, kleur: '#0d9488' },
  { code: 'V6',        label: 'V6 (55–59)', vanLeeftijd: 55, totLeeftijd: 59, volgorde: 106, kleur: '#0d9488' },
  { code: 'V7',        label: 'V7 (60–64)', vanLeeftijd: 60, totLeeftijd: 64, volgorde: 107, kleur: '#0d9488' },
  { code: 'V8',        label: 'V8 (65–69)', vanLeeftijd: 65, totLeeftijd: 69, volgorde: 108, kleur: '#0d9488' },
  { code: 'V9',        label: 'V9 (70+)',   vanLeeftijd: 70, totLeeftijd: 99, volgorde: 109, kleur: '#0d9488' },
];
